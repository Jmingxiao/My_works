...
Cube::Cube(glm::vec3 Pos,unsigned int T_ID):pos(Pos), timer(0.0f)
{
...
void Cube::SetShader(unsigned int T_ID)
{
	shader.Creat("rsc/shaders/CubeVS.shader", "rsc/shaders/CubeFS.shader", nullptr);
	shader.Bind();
	shader.Bind();
