...
bool avocado::BackDrop::Init()
{
	model_ = mat4(1.0f);


	bitmap image;
	if (!image.create("assets/wood.png")) {
	...
	// sampler
	{
		ss_.create(SAMPLER_FILTER_MODE_LINEAR, SAMPLER_ADDRESS_MODE_WRAP, SAMPLER_ADDRESS_MODE_WRAP);
	}


	vector<unsigned int> indices;
	Vertex verticies[] = {
		{ glm::vec3(-15.0f, -1.0f,-15.0f),glm::vec3(0.0f, 0.0f, 1.0f),glm::vec2(0.0f, 0.0f)},
		{ glm::vec3( 15.0f, -1.0f,-15.0f),glm::vec3(0.0f, 0.0f, 1.0f),glm::vec2(25.0f, 0.0f)},
		{ glm::vec3( 15.0f, 10.0f,-15.0f),glm::vec3(0.0f, 0.0f, 1.0f),glm::vec2(25.0f, 25.0f)},
		{ glm::vec3(-15.0f, 10.0f,-15.0f),glm::vec3(0.0f, 0.0f, 1.0f),glm::vec2(0.0f, 25.0f)},																				 
		{ glm::vec3(-15.0f, -1.0f,-15.0f),glm::vec3(0.0f, 1.0f, 0.0f),glm::vec2(0.0f, 0.0f)},
		{ glm::vec3( 15.0f, -1.0f,-15.0f),glm::vec3(0.0f, 1.0f, 0.0f),glm::vec2(15.0f, 0.0f)},
		{ glm::vec3( 15.0f, -1.0f, 15.0f),glm::vec3(0.0f, 1.0f, 0.0f),glm::vec2(15.0f, 15.0f)},
		{ glm::vec3(-15.0f, -1.0f, 15.0f),glm::vec3(0.0f, 1.0f, 0.0f),glm::vec2(0.0f, 15.0f)},
	};
	...
	//bind two buffers
	if (!buffer_.create(BUFFER_ACCESS_MODE_STATIC, (int32)sizeof(verticies), verticies)) {
...
void avocado::BackDrop::OnDraw(shader_program& shader_)
{
...
void avocado::BackDrop::DrawDepth(shader_program& depthshader_)
{
